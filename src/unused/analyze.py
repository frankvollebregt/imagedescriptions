...
from src.unused.similarity import extract_nouns, count_occurrences, compute_similarity
from src.load_xml import load_xml
from nltk.corpus import wordnet

# Early functions to read a DaisyXML DTBook file and use Azure and NLTK to analyse and try around
